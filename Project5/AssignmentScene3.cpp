...
void AssignmentScene3::Start()
{
	...
	m_basicPBRTanVertexShader = Shader(GL_VERTEX_SHADER, "../Project5\\Assets\\Shaders\\BasicPBRTangentVS.glsl");
	m_basicPBRTanFragShader = Shader(GL_FRAGMENT_SHADER, "../Project5\\Assets\\Shaders\\BasicPBRTangentFS.glsl");
	...
	//Load effects
	//Basic PBR effect
	m_basicPBRTanEffect.AddShader(&m_basicPBRTanVertexShader, &m_basicPBRTanFragShader);
	m_basicPBRTanEffect.BindShaders();
...
void AssignmentScene3::InitiScene()
{
...
void AssignmentScene3::RenderObjects()
{
...
void AssignmentScene3::DisplayScene()
{
	RenderObjects();
}

void AssignmentScene3::UpdateScene()
{
	...
	m_militia.Update(deltaTime);

	//Update time
	m_preTime = m_curTime;
}

void AssignmentScene3::OnResize(int width, int height)
{
